...
const visuals: Record<string, { icon: string; color: string; dot: string }> = {
...
const moduleVideos: Record<string, { url?: string; poster?: string }> = {
...
const relatedModules = computed(() =>
  relatedIds.value.map(id => modules.value.find(m => m.id === id)).filter(Boolean) as typeof modules.value
)
  ...
  <template v-if="moduleEntry">
        ...
        <div class="grid grid-cols-12 gap-6 lg:gap-12">
          <div class="col-span-12 lg:col-span-5">
            <div class="lg:sticky lg:top-28">
              <p class="text-xs uppercase tracking-[0.25em] text-gray-400 mb-4">—— {{ copy.ui.whatItDoes }}</p>
      ...
      <div class="max-w-7xl mx-auto px-5 sm:px-8">
        <div class="grid grid-cols-12 gap-6 mb-10">
          <div class="col-span-12 sm:col-span-4 lg:col-span-3">
            <p class="text-xs uppercase tracking-[0.25em] text-gray-400">—— {{ copy.ui.whatItLooksLike }}</p>
          </div>
    ...
    <section v-if="relatedModules.length" class="py-16 sm:py-20 border-t border-black/10 dark:border-white/10">
      <div class="max-w-7xl mx-auto px-5 sm:px-8">
        <div class="grid grid-cols-12 gap-6 mb-10">
          <div class="col-span-12 sm:col-span-4 lg:col-span-3">
            <p class="text-xs uppercase tracking-[0.25em] text-gray-400">—— {{ copy.ui.worksBestWith }}</p>
  ...
  <template v-else>
    <section class="py-28">
      <div class="max-w-2xl mx-auto px-5 text-center">
        <p class="text-xs uppercase tracking-[0.25em] text-gray-400 mb-4">—— {{ copy.ui.moduleNotFoundEyebrow }}</p>
